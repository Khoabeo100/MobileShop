...
import { requestUpdateUser, requestChangeAvatar } from '../../../config/request';
...
function PersonalInfo() {
    ...
    const handleChange = async (info) => {
        ...
        try {
            await requestChangeAvatar(formData);
    ...
    console.log(`${import.meta.env.VITE_API_URL}/${dataUser?.avatar}`);
